(() => {
    ...
    let yOffset; // window.pageYOffset 대신 쓸 변수
    ...
    const sceneInfo = [
        ...
        },
        {
            ...
            objs: {
                ...
                pinB: document.querySelector('#scroll-section-2 .main-message .c .pin'),
                pinC: document.querySelector('#scroll-section-2 .main-message .c .pin'),
            },
            values: {
                messageA_opacity_in: [0, 1, {start: 0.1, end: 0.2}],
                messageB_opacity_in: [0, 1, {start: 0.3, end: 0.4}],
    ...
    function playAnimation() {
        ...
        switch (currentScene) {
            case 0:
                ...
                if(scrollRatio > 0.3 && scrollRatio <= 0.42) {
                ...
                if(scrollRatio > 0.5 && scrollRatio <= 0.62) {
                ...
                if(scrollRatio > 0.7 && scrollRatio <= 0.82) {
